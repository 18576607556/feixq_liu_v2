(function(e) {
    function n(n) {
        for (var a, c, u = n[0], s = n[1], i = n[2], d = 0, f = []; d < u.length; d++)
            c = u[d],
    ...
    function u(e) {
        return s.p + "js/" + ({}[e] || e) + "." + {
            ...
            "chunk-0cc2b1d2": "ed6749dd",
            "chunk-1a57894c": "d6f218ce",
            "chunk-2dfd2882": "d53ef162",
            "chunk-38297f09": "3fb35fd9",
            "chunk-3a6b8ea4": "c47e7d57",
            "chunk-5e9260f4": "83110106",
            "chunk-75007d2d": "c2c5e1a8",
    ...
    function s(n) {
        ...
        return e[n].call(t.exports, t, t.exports, s),
        t.l = !0,
        t.exports
    }
    s.e = function(e) {
        ...
        c[e] ? n.push(c[e]) : 0 !== c[e] && t[e] && n.push(c[e] = new Promise((function(n, t) {
            for (var a = "css/" + ({}[e] || e) + "." + {
                ...
                "chunk-0cc2b1d2": "b8503de5",
                "chunk-1a57894c": "2e989537",
                "chunk-2dfd2882": "92b44ed4",
                "chunk-38297f09": "524610d9",
                "chunk-3a6b8ea4": "6fab17dc",
                "chunk-5e9260f4": "e08070e6",
                "chunk-75007d2d": "57a4b269",
                ...
                if ("stylesheet" === i.rel && (d === a || d === r))
                    return n()
            }
            var f = document.getElementsByTagName("style");
            for (u = 0; u < f.length; u++) {
                i = f[u],
                d = i.getAttribute("data-href");
                if (d === a || d === r)
                    return n()
            }
    ...
    "199c": function(e, n) {
        (function() {
            ...
            e.src = "https://hm.baidu.com/hm.js?144df23b003dd2efc27a542bdb5bd069";
    ...
    "56d7": function(e, n, t) {
        ...
        const V = [{
            path: "/",
            name: "home",
            component: ()=>t.e("chunk-75007d2d").then(t.bind(null, "37f9"))
        }, {
            path: "/truthOrDare/:type",
            name: "truthOrDare",
            component: ()=>t.e("chunk-2dfd2882").then(t.bind(null, "b350"))
        }, {
            path: "/plane/:type",
            name: "plane",
            ...
            path: "/turnTable/:type",
            name: "turnTable",
            component: ()=>t.e("chunk-1a57894c").then(t.bind(null, "406a"))
        }, {
            path: "/setTable",
            name: "setTable",
            ...
            path: "/rose/:type",
            name: "rose",
            component: ()=>t.e("chunk-0cc2b1d2").then(t.bind(null, "c058"))
        }, {
            path: "/setRose",
            name: "setRose",
            ...
            path: "/egg/:type",
            name: "egg",
            component: ()=>t.e("chunk-5e9260f4").then(t.bind(null, "440a"))
        }]
          , X = new W["a"]({
            base: "",
            routes: V
        ...
        t("2877"))
          ...
          , se = (t("54f4"),
        t("98c9"));
        Z.a.component("svg-icon", ue),
        Z.a.prototype.$ImagePreview = J["a"],
        Z.a.use(se["a"]),
        Z.a.config.productionTip = !1,
        Z.a.config.productionTip = !1,
        Z.a.use(a["a"]).use(c["a"]).use(r["a"]).use(o["a"]).use(u["a"]).use(s["a"]).use(i["a"]).use(d["a"]).use(f["a"]).use(l["a"]).use(p["a"]).use(h["a"]).use(b["a"]).use(m["a"]).use(v["a"]).use(g["a"]).use(k["a"]).use(y["a"]).use(w["a"]).use(_["a"]).use(O["a"]).use(x["a"]).use(E["a"]).use(S["a"]).use(T["a"]).use(j["a"]).use(N["a"]).use(P["a"]).use(I["a"]).use(D["a"]).use(F["a"]).use(C["a"]).use(A["a"]).use(L["a"]).use(M["a"]).use(B["a"]).use(R["a"]).use(G["a"]).use(U["a"]).use(q["a"]).use($["a"]),
        new Z.a({
            router: ee,
            store: Q,
