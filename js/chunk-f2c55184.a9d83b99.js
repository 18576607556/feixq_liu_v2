(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-f2c55184"], {
    "16de": function(t, s) {
          ...
          , c = {
            ...
            mounted() {
                if (1 == this.$route.params.type)
                    this.titleName = "情趣骰子-初级骰子",
                    this.diceList = this.list1;
                else if (2 == this.$route.params.type)
                    this.titleName = "情趣骰子-进阶骰子",
                    this.diceList = this.list2;
                    ...
                    this.titleName = t[s].name,
                    this.diceList = t[s].list
                }
            },
            methods: {
                go() {
                    this.gobtn && (this.gobtn = !1,
                    this.turn())
                },
                turn() {
                    let t = document.getElementById("cube1")
                      ...
                      , e = 0
                      , A = 0;
                    if (e = Math.floor(6 * Math.random()) + 1,
                    A = Math.floor(6 * Math.random()) + 1,
                    e == this.one || A == this.two)
                        return console.log("let", e, A),
                        console.log("this", this.one, this.two),
                        void this.turn();
                    switch (this.one = e,
                    this.two = A,
                    e) {
                    case 1:
                        t.className = "cube",
                        t.classList.add("rotate1");
                        break;
                    case 2:
                        t.className = "cube",
                        t.classList.add("rotate2");
                        break;
                    case 3:
                        t.className = "cube",
                        t.classList.add("rotate3");
                        break;
                    case 4:
                        t.className = "cube",
                        t.classList.add("rotate4");
                        break;
                    case 5:
                        t.className = "cube",
                        t.classList.add("rotate5");
                        break;
                    case 6:
                        t.className = "cube",
                        t.classList.add("rotate6");
                        break;
                    default:
                        break
                    }
                    ...
                    case 1:
                        s.className = "cube",
                        s.classList.add("rotate1");
                        break;
                    case 2:
                        s.className = "cube",
                        s.classList.add("rotate2");
                        break;
                    case 3:
                        s.className = "cube",
                        s.classList.add("rotate3");
                        break;
                    case 4:
                        s.className = "cube",
                        s.classList.add("rotate4");
                        break;
                    case 5:
                        s.className = "cube",
                        s.classList.add("rotate5");
                        break;
                    case 6:
                        s.className = "cube",
                        s.classList.add("rotate6");
                        break;
                    default:
                        break
                    }
