(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-3a6b8ea4"], {
    "16de": function(e, t) {
                ...
                putGame() {
                    if (this.name) {
                        ...
                        if (localStorage.getItem("diceList")) {
                            ...
                            t.push(e),
                            console.log("obj2", t),
                            localStorage.setItem("diceList", JSON.stringify(t))
                        } else
                            localStorage.setItem("diceList", JSON.stringify([e]));
                        Object(l["a"])("保存成功"),
                        this.turnHome()
                    } else
                        Object(l["a"])("请输入游戏名称")
