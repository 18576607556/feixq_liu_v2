(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-5e9260f4"], {
    "16de": function(s, e) {
    ...
    "440a": function(s, e, t) {
        ...
        t("cc18"))
          , i = {
            ...
            mounted() {
                if (1 == this.$route.params.type)
                    this.titleName = "情趣玫瑰-初级玫瑰",
                    this.diceList = this.list1;
                    ...
                    let s = JSON.parse(localStorage.getItem("diceList"))
                      , e = this.$route.params.type.split("-")[1];
                    this.titleName = s[e].name,
                    this.diceList = s[e].list
                }
            ...
            methods: {
                hideBox() {
                    ...
                    let s = document.getElementById("roseTipBox")
                      , e = document.getElementById("roseTip");
                    this.showText = !1,
                    s.classList.remove("animationRoseBox1"),
                    e.classList.remove("animationRoseBox1"),
                    s.classList.remove("animationRoseBox2"),
                    e.classList.remove("animationRoseBox2"),
                    s.classList.remove("animationRoseBox3"),
                    e.classList.remove("animationRoseBox3"),
                    s.classList.remove("animationRoseBox4"),
                    e.classList.remove("animationRoseBox4"),
                    s.classList.remove("animationRoseBox5"),
                    e.classList.remove("animationRoseBox5"),
                    s.classList.remove("animationRoseBox6"),
                    e.classList.remove("animationRoseBox6"),
                    s.classList.remove("animationRoseBox7"),
                    e.classList.remove("animationRoseBox7"),
                    s.classList.remove("animationRoseBox8"),
                    e.classList.remove("animationRoseBox8"),
                    s.classList.remove("animationRoseBox9"),
                    e.classList.remove("animationRoseBox9");
                ...
                showRoseBox(s) {
                    ...
                    let e = document.querySelectorAll(".roseImg")
                      , t = document.getElementById("roseTipBox")
                      , A = document.getElementById("roseTip");
                    e.forEach(s=>{
                        s.classList.remove("roseImgRotate")
                    }
                    ),
                    e[s].classList.add("roseImgWidth"),
                    setTimeout(()=>{
                        let o = this.diceList.length - 1;
                        switch (this.text = this.diceList[Math.floor(Math.random() * o)],
                        s) {
                        case 0:
                            t.classList.add("animationRoseBox1"),
                            A.classList.add("animationRoseBox1");
                            break;
                        case 1:
                            t.classList.add("animationRoseBox2"),
                            A.classList.add("animationRoseBox2");
                            break;
                        case 2:
                            t.classList.add("animationRoseBox3"),
                            A.classList.add("animationRoseBox3");
                            break;
                        case 3:
                            t.classList.add("animationRoseBox4"),
                            A.classList.add("animationRoseBox4");
                            break;
                        case 4:
                            t.classList.add("animationRoseBox5"),
                            A.classList.add("animationRoseBox5");
                            break;
                        case 5:
                            t.classList.add("animationRoseBox6"),
                            A.classList.add("animationRoseBox6");
                            break;
                        case 6:
                            t.classList.add("animationRoseBox7"),
                            A.classList.add("animationRoseBox7");
                            break;
                        case 7:
                            t.classList.add("animationRoseBox8"),
                            A.classList.add("animationRoseBox8");
                            break;
                        case 8:
                            t.classList.add("animationRoseBox9"),
                            A.classList.add("animationRoseBox9");
                            break;
                        default:
                            break
                        }
                        this.showText = !0,
                        e[s].classList.remove("roseImgWidth")
                    }
                    , 2e3)
                },
                turnHome() {
          ...
          , c = (t("b7ec"),
        t("2877"))
          , B = Object(c["a"])(n, A, o, !1, null, "03a147d8", null);
        e["default"] = B.exports
    },
    "50fb": function(s, e, t) {},
    5933: function(s, e) {
    ...
    cc18: function(s, e, t) {
        ...
        var A = function() {
            ...
            }), e("span", [s._v(s._s(s.title))]), e("img", {
                directives: [{
                    name: "show",
                    rawName: "v-show",
                    value: s.showNewGame,
          ...
          , n = (t("d297"),
        t("2877"))
          , c = Object(n["a"])(i, A, o, !1, null, "7ed464c4", null);
        e["a"] = c.exports
    },
    d297: function(s, e, t) {
        "use strict";
