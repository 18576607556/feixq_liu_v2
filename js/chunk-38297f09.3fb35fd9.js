(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-38297f09"], {
    "16de": function(e, A) {
    ...
    "5b16": function(e, A, t) {
        ...
        t("cc18"))
          , m = {
            ...
            methods: {
                save() {
                    this.m.m1 && this.m.m2 && this.m.m3 && this.m.m4 && this.m.m5 && this.m.m6 && this.m.m7 && this.m.m8 && this.m.m9 ? this.showTip = !0 : Object(o["a"])("数据未填写完整，请填写完整后再提交")
                },
                putGame() {
                    if (this.name) {
                        let e = {
                            name: this.name,
                            list: ["", this.m.m1, this.m.m2, this.m.m3, this.m.m4, this.m.m5, this.m.m6, this.m.m7, this.m.m8, this.m.m9]
                        };
                        if (localStorage.getItem("roseList")) {
                            let A = JSON.parse(localStorage.getItem("roseList"));
                            A.push(e),
                            console.log("obj2", A),
                            localStorage.setItem("roseList", JSON.stringify(A))
                        } else
                            localStorage.setItem("roseList", JSON.stringify([e]));
                        Object(o["a"])("保存成功"),
                        this.turnHome()
                    } else
                        Object(o["a"])("请输入游戏名称")
