(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-b0a6332a"], {
    "06d6": function(t, e, a) {
        "use strict";
        a.r(e);
        var s = function() {
                ...
                putGame() {
                    if (this.name) {
                        ...
                        if (localStorage.getItem("gameList")) {
                            ...
                            e.push(t),
                            console.log("obj2", e),
                            localStorage.setItem("gameList", JSON.stringify(e))
                        } else
                            localStorage.setItem("gameList", JSON.stringify([t]));
                        Object(o["a"])("保存成功"),
                        this.turnHome()
                    } else
                        Object(o["a"])("请输入游戏名称")
