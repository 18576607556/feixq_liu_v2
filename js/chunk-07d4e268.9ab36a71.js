(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-07d4e268"], {
    "16de": function(e, t) {
                ...
                putGame() {
                    if (this.name) {
                        ...
                        if (localStorage.getItem("tableList")) {
                            ...
                            t.push(e),
                            console.log("obj2", t),
                            localStorage.setItem("tableList", JSON.stringify(t))
                        } else
                            localStorage.setItem("tableList", JSON.stringify([e]));
                        Object(l["a"])("保存成功"),
                        this.turnHome()
                    } else
                        Object(l["a"])("请输入游戏名称")
